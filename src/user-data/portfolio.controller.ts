...
export class PortfolioController {
  ...
  private holdingsCol(uid: string) {
    return this.firebase.firestore.collection(`users/${uid}/portfolios/default/holdings`);
  }
  ...
  async add(
    ...
    const positionSize = POSITION_SIZES.includes(body.positionSize as PositionSize)
  ...
  async remove(@CurrentUser() uid: string, @Param('ticker') ticker: string): Promise<{ ok: true }> {
