...
import { AlphaVantageModule } from '../vendors/alphavantage/alphavantage.module';
 ...
 */
@Module({
  imports: [LiveModule, AdaptersModule, FredModule, PolygonModule, SecEdgarModule, AlphaVantageModule],
  controllers: [
