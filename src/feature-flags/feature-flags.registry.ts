...
export const FEATURE_FLAGS: FeatureFlagDef[] = [
  ...
  { key: 'FF_DASHBOARD', row: 'R11', label: 'Dashboard core widgets', defaultOn: true },
  // ── W2 — live ────────────────────────────────────────────────────────────
  ...
  { key: 'FF_NAMESEARCH', row: 'R17', label: 'Company-name search', defaultOn: true },
  // ── W3 — live ────────────────────────────────────────────────────────────
  { key: 'FF_PORTFOLIO', row: 'R19', label: 'Portfolio Pulse', defaultOn: true },
  ...
  { key: 'FF_FEARGREED', row: 'R26', label: 'Fear & Greed gauge', defaultOn: true },
  // ── W5+ — not yet built: default OFF until their row is delivered ─────────
  { key: 'FF_RECAPS_DATA', row: 'R28', label: 'Recaps EOD data', defaultOn: false },
  { key: 'FF_EPSHIST', row: 'R29', label: '10-quarter EPS history', defaultOn: false },
  { key: 'FF_OPTIONS', row: 'R32', label: 'Options Chain (greeks/IV/OI)', defaultOn: false },
  { key: 'FF_AI_WMN', row: 'R35', label: "Dashboard 'What Matters Now' AI", defaultOn: false },
  { key: 'FF_AI_RECAPS', row: 'R36', label: 'Recaps AI narrative', defaultOn: false },
  { key: 'FF_AI_STOCK', row: 'R38', label: 'Stock Detail AI', defaultOn: false },
  { key: 'FF_AI_MISC', row: 'R39', label: 'Misc AI notes', defaultOn: false },
  { key: 'FF_ANALYST_EVENTS', row: 'R41', label: 'Analyst per-firm events', defaultOn: false },
  { key: 'FF_EARNINGS_DEPTH', row: 'R42', label: 'Earnings depth', defaultOn: false },
  { key: 'FF_OPTIONS_FLOW', row: 'R43', label: 'Options flow / dark pool', defaultOn: false },
  { key: 'FF_ALERTS', row: 'R44', label: 'Alerts engine', defaultOn: false },
  { key: 'FF_REAL_CALENDARS', row: 'R47', label: 'Real date-range calendars', defaultOn: true },
];
