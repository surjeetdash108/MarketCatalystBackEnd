...
>
> **This doc, specifically:** The SSE tape + cached snapshot pipeline will
> behave identically on stage once its `live` Cloud Run service is deployed;
> today stage has no backend, so live prices are prod-only.
>
