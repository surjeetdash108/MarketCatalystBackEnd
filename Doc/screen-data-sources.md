...
| Element | Data | Status |
|---|---|---|
| Calendar (Day/Week toggle, date navigator + mini-calendar, Before Open/After Close/Both, live rows) | `earnings_events` only — a row exists iff a real doc matches the date; no mock rows blended in | ✅ Live |
